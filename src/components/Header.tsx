...
const Header = () => {
  const [isShowDrawer, toggleDrawer] = useState(false)

  return (
    <header className="relative">
      <Image width={375} height={650} className="w-full object-cover md:hidden" src="./images/mobile/image-hero.jpg" alt="hero" />
      <Image width={1440} height={600} className="hidden w-full object-cover md:block" src="./images/desktop/image-hero.jpg" alt="hero" />
      <nav className="navbar absolute top-5 lg:top-12 lg:px-44">
        <div className="z-50 flex-1">
          <Link href="./" className=" px-6 text-xl normal-case lg:px-0">
        ...
        <div className="flex-none px-3 ">
          <div className="drawer drawer-end lg:hidden ">
            <input id="my-drawer" type="checkbox" className="drawer-toggle" checked={isShowDrawer} onChange={() => toggleDrawer(!isShowDrawer)} />
            <div className="drawer-content z-50">
              {/* eslint-disable-next-line tailwindcss/classnames-order */}
              <label htmlFor="my-drawer" className={`${isShowDrawer && 'swap-active'} swap-rotate btn btn-ghost swap drawer-button active:btn-active`}>
                <svg className="swap-off fill-primary" width="24" height="16" xmlns="http://www.w3.org/2000/svg"><g fillRule="evenodd"><path d="M0 0h24v2H0zM0 7h24v2H0zM0 14h24v2H0z" /></g></svg>
                <svg className="swap-on fill-primary " width="20" height="20" xmlns="http://www.w3.org/2000/svg"><path d="M17.778.808l1.414 1.414L11.414 10l7.778 7.778-1.414 1.414L10 11.414l-7.778 7.778-1.414-1.414L8.586 10 .808 2.222 2.222.808 10 8.586 17.778.808z" fillRule="evenodd" /></svg>
              </label>
            </div>
            <div className="drawer-side z-40">
              <label htmlFor="my-drawer" className="drawer-overlay" />
              <ul className="min-h-full w-screen space-y-10 bg-neutral px-16 pt-56 font-secondary text-4xl uppercase text-primary hover:[&_a]:underline">
          ...
          <ul className="hidden gap-10 text-primary lg:flex">
            <li><Link className="link-underline" href="./">About</Link></li>
            <li><Link className="link-underline" href="./">Carrers</Link></li>
            <li><Link className="link-underline" href="./">Events</Link></li>
            <li><Link className="link-underline" href="./">Products</Link></li>
            <li><Link className="link-underline" href="./">Support</Link></li>
          </ul>
        </div>
      </nav>
      <div className="absolute top-0 flex h-full items-center justify-center p-8 lg:top-7 lg:px-44">
        <h1 className="border-2 border-primary p-6 font-secondary text-5xl text-primary lg:max-w-2xl lg:p-10 lg:text-7xl">
